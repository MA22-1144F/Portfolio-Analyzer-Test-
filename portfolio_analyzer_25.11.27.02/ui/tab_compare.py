"""
tab_compare.py - ポートフォリオ比較分析タブ（拡張版）
複数のポートフォリオを選択して、各種評価指標で比較分析を行う
...
from PySide6.QtWidgets import (
    ...
    QTabWidget, QHeaderView, QMessageBox, QCheckBox, QTextEdit,
    QScrollArea, QFrame, QFormLayout, QApplication, QProgressDialog
)
...
class CompareTab(QWidget):
    ...
    def _execute_analysis(self):
        ...
        self.logger.info(f"比較ベース: {'CAPM' if use_capm else '実績値'}")
