...
class MainWindow(QMainWindow):
    ...
    def _connect_analysis_widget_signal(self, analysis_widget):
        """✨ 新規追加：分析ウィジェットのportfolio_export_requestedシグナルを接続"""
...
注意：レバレッジはリスクを高めます"""
    ...
    def show_about(self):
        """バージョン情報"""
        about = """Portfolio Analyzer v1.2.0
