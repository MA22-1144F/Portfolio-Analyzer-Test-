...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QProgressBar, QMessageBox,
    QPushButton, QApplication, QComboBox, QGroupBox, QFileDialog,
    QSplitter, QFrame, QTabWidget, QTextEdit, QTableWidget, QTableWidgetItem
)
...
class SecurityMarketLineCalculationThread(QThread):
    ...
    def _convert_risk_free_rate_to_span(self, annual_rate: float, span: str) -> float:
        """年率の無リスク利子率をスパンに応じて変換（設定ファイル対応版）"""
        try:
            # 設定から変換係数を取得
