...
class PortfolioEfficiency:
    ...
    def calculate_efficiency_metrics(
        ...
        Args:
            portfolio_metrics: ポートフォリオの基本統計量
            market_metrics: 市場ポートフォリオの統計量（オプション）
...
def calculate_all_portfolios_efficiency(
    ...
    Args:
        all_metrics: {portfolio_name: metrics}
        market_metrics: 市場ポートフォリオの統計量
    
    Returns:
        dict: {portfolio_name: efficiency_metrics}
    """
