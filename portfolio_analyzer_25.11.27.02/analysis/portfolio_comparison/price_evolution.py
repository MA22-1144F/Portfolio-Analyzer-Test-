"""
price_evolution.py - 価格推移チャート

複数ポートフォリオの累積リターンを時系列で可視化
"""
...
def create_price_evolution_matplotlib_chart(
    ...
    Args:
        portfolios: Portfolio objectsのリスト
        price_data: 銘柄コード -> 価格データのDict
...
# テスト用関数は省略（実際のPortfolioオブジェクトとprice_dataが必要）
